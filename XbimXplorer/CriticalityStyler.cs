...
{
    public class CriticalityStyler : ILayerStyler, IProgressiveLayerStyler
    {
        public event ProgressChangedEventHandler ProgressChanged;

        readonly XbimColourMap _colourMap = new XbimColourMap();

        Dictionary<int, ShadedElement> elements;

      
        public XbimColour[] colsPerCriticality = new XbimColour[]
        {
            new XbimColour("Critical",181.0/255.0, 37.0/255.0, 27.0/255.0, 0.5),
            new XbimColour("Major",255.0/255.0, 132.0/255.0, 39.0/255.0, 0.5),
            new XbimColour("Moderate",255.0/255.0, 185.0/255.0, 29.0/255.0, 0.5),
            new XbimColour("Minor",62.0/255.0, 204.0/255.0, 180.0/255.0, 0.5),
            new XbimColour("Negligible",149.0/255.0, 201.0/255.0, 61.0/255.0, 0.5),
            new XbimColour("None",125.0/255.0, 125.0/255.0, 125.0/255.0, 0.5)
    };
        ...
        public void setElements(Dictionary<int, ShadedElement> elements)
        {
        ...
        protected IfcBuildingElement getElement(IModel model, int id)
        {
            var element = model.Instances[id] as IfcBuildingElement;
